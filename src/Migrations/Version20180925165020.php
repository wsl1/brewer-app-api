 ...
 */
final class Version20180925165020 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE beers (id INT AUTO_INCREMENT NOT NULL, brewer INT DEFAULT NULL, name VARCHAR(255) NOT NULL, price_per_litre INT NOT NULL, country VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, img LONGTEXT NOT NULL, INDEX IDX_B331E6388C2B4A4B (brewer), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
